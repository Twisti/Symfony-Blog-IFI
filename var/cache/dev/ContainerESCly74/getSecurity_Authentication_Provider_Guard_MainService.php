...
return $this->privates['security.authentication.provider.guard.main'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
    yield 0 => ($this->privates['App\Security\LoginUserAuthenticator'] ?? $this->load('getLoginUserAuthenticatorService.php'));
}, 1), ($this->privates['security.user.provider.concrete.our_db_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_OurDbProviderService.php')), 'main', new \Symfony\Component\Security\Core\User\UserChecker());
